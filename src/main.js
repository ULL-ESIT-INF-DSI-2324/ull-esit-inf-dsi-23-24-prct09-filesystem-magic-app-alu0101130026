...
function uploadCards(usuario) {
  ...
  archivos.forEach(function (archivo) {
    var contenido = fs_1.default.readFileSync(
      "".concat(directorio, "/").concat(archivo),
      "utf-8",
    );
...
(0, yargs_1.default)((0, helpers_1.hideBin)(process.argv)).command({
  ...
  handler: function (args) {
    ...
    if (fs_1.default.existsSync(archivo)) {
      ...
      console.log(
        chalk_1.default.red("No se encontró ninguna carta con ese ID."),
      );
    }
  },
});
...
(0, yargs_1.default)((0, helpers_1.hideBin)(process.argv)).command({
  ...
  handler: function (args) {
    ...
    if (fs_1.default.existsSync(directorio)) {
      ...
      console.log(
        chalk_1.default.red("No se encontraron cartas en la colección."),
      );
    }
  },
});
